...
fn main() {
    ...
    let (lhs_0, lhs_1, lhs_2, lhs_3, lhs_4, lhs_5,
         rhs_0, rhs_1, rhs_2, rhs_3, rhs_4, rhs_5,
         prime, primesqr5):
        (BigUint, BigUint, BigUint, BigUint, BigUint, BigUint,
         BigUint, BigUint, BigUint, BigUint, BigUint, BigUint,
         BigUint, BigUint) = env::read();
    let lhs = [lhs_0.to_u32_array(), lhs_1.to_u32_array(), lhs_2.to_u32_array(),
               lhs_3.to_u32_array(), lhs_4.to_u32_array(), lhs_5.to_u32_array()];
    let rhs = [rhs_0.to_u32_array(), rhs_1.to_u32_array(), rhs_2.to_u32_array(),
               rhs_3.to_u32_array(), rhs_4.to_u32_array(), rhs_5.to_u32_array()];
    ...
    risc0_bigint2::field::extfield_degsix_mul_384(&lhs, &rhs, &prime, &primesqr5, &mut result);
